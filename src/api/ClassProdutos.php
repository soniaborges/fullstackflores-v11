...
class ClassProdutos extends ClassConexao {
    ...
    {
        $BFetch=$this->conectaDB()->prepare("select *  FROM categorias_produtos
        INNER JOIN categorias
        ON categorias.idcategoria = categorias_produtos.idcategoria
        INNER JOIN produtos 
        ON produtos.idproduto = categorias_produtos.idproduto;");
        $BFetch->execute();
